...
impl Backend {
    ...
    pub fn open_tenant(path: &Path, memory_mb: u64, max_threads: u64) -> Result<Self, String> {
    ...
    pub fn open_with_config(path: &Path, config: lbug::SystemConfig) -> Result<Self, String> {
